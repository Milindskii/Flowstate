            ...
            children: [
              ...
              TextField(
                ...
                decoration: const InputDecoration(
                  ...
                  prefixIcon: Icon(Icons.email_outlined, color: FlowColors.textSecondary),
                ),
              ),
              ...
              TextField(
                ...
                decoration: const InputDecoration(
                  hintText: 'Password',
                  prefixIcon: Icon(Icons.lock_outline_rounded, color: FlowColors.textSecondary),
                ),
              ),
              const SizedBox(height: 24),
              PrimaryButton(
                label: _isLoginMode ? 'Log In' : 'Get Started',
                onPressed: () {
                  Navigator.pop(ctx);
                  if (_isLoginMode) {
